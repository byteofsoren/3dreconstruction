...
% Par skipping for paragraphs and visual indentations
\setlength{\parindent}{5em}
\setlength{\parskip}{3mm}
% \ReNewDocumentCommand\baselinestretch{3.0}
...
\newpage
\input{sections/02_initial_thougts.tex} %SOTA
\newpage
% \input{sections/06_contribs}
% \newpage
\input{sections/05_etics}
\newpage
