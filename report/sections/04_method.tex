...
%Dijkstra c
This is covered visually in figure~\ref{fig:method:overview} that shows how the system takes images and process them to become results tables covered in~\ref{sec:results} Results.
