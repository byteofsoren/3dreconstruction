...
\end{center}
\caption{
\todo[inline]{Note: this seams to be a log normal distrubution, not a normal distributed. Perhaps change f test to other test.}
...
\begin{table}[htb]
    ...
    \end{center}
    \caption{
    Testing \openpose directional invariance against its own data provides the following results for the F-test based on ANOVA\@.
    The p values in the right most column is lower the 0.05 thus indicating that the $h_0$ hypotheses do not hold.
    However the large q values above 1 can tell us that this perhaps true and instead is false positive.
    This can be because the data inputted to the image has not a normal distributed function as shown in figure~\ref{fig:results:dirbox}
    }
...
\begin{center}
    ...
    \begin{minipage}[b]{0.40\linewidth}
        \includegraphics[width=1\linewidth]{../results/correct_pos/south_west_high.png}\vspace{4pt}
        \includegraphics[width=1\linewidth]{../results/correct_pos/north_west_high.png}\vspace{4pt}
        \includegraphics[width=1\linewidth]{../results/correct_pos/east_high.png}\vspace{4pt}
    \end{minipage}
    \begin{minipage}[b]{0.40\linewidth}
        \includegraphics[width=1\linewidth]{../results/correct_pos/north_high.png}\vspace{4pt}
        \includegraphics[width=1\linewidth]{../results/correct_pos/north_low.png}\vspace{4pt}
        \includegraphics[width=1\linewidth]{../results/correct_pos/west_low_close.png}\vspace{4pt}
    \end{minipage}
\end{center}
